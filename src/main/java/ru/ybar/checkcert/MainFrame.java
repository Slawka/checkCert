...
public class MainFrame extends javax.swing.JFrame {
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addComponent(jButtonUpload, javax.swing.GroupLayout.PREFERRED_SIZE, 105, javax.swing.GroupLayout.PREFERRED_SIZE))
    ...
    private void jButtonDelActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonDelActionPerformed
        ...
        if (selectRow.equals(delId)) {
            ...
            JOptionPane.showMessageDialog(MainFrame.this, "Del ID and the selected row does not match\n"+"Del ID = |"+jTextFieldDelId.getText().trim()+"|\n"+"Id Row = |"+jTable1.getValueAt(selectedRow[0], 0)+"|");
            return;
        }
